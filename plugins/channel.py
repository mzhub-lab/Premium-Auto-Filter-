...
{}</blockquote>
<blockquote>〽️ <b>Powered By:</b> <a href='https://t.me/MzBotz'>@MzBotz</a></blockquote>"""
...
async def send_movie_update(bot, file_name, files):
    try:
        ...
        file_poster = next((f["file_thumb"] for f in files if f.get("file_thumb")), None)
        if file_poster:
            poster_image = file_poster
        else:
        ...
        for file in files:
            ...
            if match:
                ...
                # Combined link: Size link tag ke bahar hai
        ...
        # Movie format: Size link se bahar alag code block me dikhega
        if not quality_text:
