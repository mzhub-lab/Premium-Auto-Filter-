...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1004489790667").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1003948498853"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1003948498853"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1004457217205"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1004457217205"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1004457217205"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "")
DATABASE_NAME = environ.get("DATABASE_NAME", "vlzfiles")
...
request_channel = environ.get("REQUEST_CHANNEL", "-1001886400749")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1004370414554"))
...
SHORTENER_API = environ.get("SHORTENER_API", "f565edfbea9e9a7e0ca7a758bbb580bf614d4487")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "arolinks.com")
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "3b623c80e2c2534a5eae0bae35777c4c1aedd154"
)
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://graph.org/file/2fbfda2e8ddd611ec08f6-bd9dc35f731ea40868.jpg https://i.ibb.co/DQ35zLZ/image.jpg",
    )
).split()
FORCESUB_IMG = environ.get("FORCESUB_IMG", "https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg")
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://files.catbox.moe/uycn3p.jpg")
).split()
