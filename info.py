...
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1003998775841"))
...
request_channel = environ.get("REQUEST_CHANNEL", "-1004434857614")
REQUEST_CHANNEL = (
    int(request_channel)
...
if "DYNO" in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "naval-klarika-vlzbots-88759354.koyeb.app/")
